                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children active dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="{{url('pagawai')}}">Pegawai</a></li>
                            <li><i class="fa fa-table"></i><a href="{{url('menu')}}">Menu</a></li>
                            <li><i class="fa fa-table"></i><a href="#">Transaksi</a></li>
                            @else
                            
                            <li><i class="fa fa-table"></i><a href="{{url('koki ')}}">Koki</a></li>
                            @endif
                        </ul>
                    </li>
